$(document).ready(function() {
    ...
    //initial array of sport starter buttons

    var topics = ["Football", "Bowling", "Basketball", "Baseball", "Soccer", "Hockey", "Golf", "Curling", "College Wrestling"];
    ...
    function displayInfo() {
        ...
        var queryURL = "http://api.giphy.com/v1/gifs/search?q=" + sport + "&api_key=K1XIgOK1a5eX20IPctYeUU8ue9NX3xAD&limit=10";
        ...
        console.log(response);
            ...
            //loop to grab the rating information and appropriate gif for button clicked into its own div to keep information together
